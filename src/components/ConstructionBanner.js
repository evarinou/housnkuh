...
const ConstructionBanner = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 my-8">
      <div className="bg-[var(--secondary)] text-white rounded-lg shadow-lg overflow-hidden transform -rotate-1 hover:rotate-0 transition-transform duration-300">
        <div className="relative px-6 py-8">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-center">
              <div className="bg-[var(--primary)] rounded-full p-4 mr-4">
          ...
          <div className="absolute -top-4 -right-4 transform rotate-12">
            <AlertTriangle className="w-12 h-12 text-[var(--primary)] opacity-40" />
          </div>
          <div className="absolute -bottom-4 -left-4 transform -rotate-12">
            <Settings className="w-10 h-10 text-[var(--primary)] opacity-40" />
          </div>
        </div>
