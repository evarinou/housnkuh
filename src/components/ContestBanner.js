...
import { useNavigate } from 'react-router-dom'; // Importiere useNavigate für Routing
...
const ContestBanner = () => {
  ...
  const navigateToVendors = () => {
    navigate('/vendors'); // Navigation zur Vendors-Seite
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-[#09122c] to-[#192254] text-white rounded-lg shadow-xl p-6 border-2 border-[#e17564]">
        <button 
        ...
        <div className="flex items-center gap-3 mb-4">
          <Award className="text-[#e17564] w-8 h-8 flex-shrink-0 animate-pulse" />
        ...
        <button 
          ...
          className="inline-flex items-center justify-center gap-2 bg-[#e17564] text-white px-5 py-3 rounded-lg hover:bg-opacity-90 transition-all duration-200 font-medium"
        >
