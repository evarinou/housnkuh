      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex justify-center mt-8">
          <a 
            ...
            className="inline-flex items-center gap-2 bg-[var(--primary)] hover:bg-[var(--primary)]/90 text-white px-6 py-3 rounded-lg transition-colors duration-200 font-medium"
          >
