...
const PackageBuilder = () => {
  ...
  const packageOptions = [
    ...
    },
    {
      ...
      price: 50,
      description: 'Gekühlter Bereich für temperaturempfindliche Produkte (Sowohl Kühl- als auch Gefrierfläche verfügbar)',
      image: '/api/placeholder/200/150',
...
useEffect(() => {
  ...
  }, [selectedProvisionType, selectedPackages, selectedAddons, rentalDuration, packageOptions, addonOptions, provisionTypes]);
      ...
      {!showSummary ? (
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a
              href="/contact"
              className="bg-[#e17564] text-white px-6 py-2 rounded-lg font-medium hover:bg-[#e17564]/90 transition-colors"
            >
              Zum Kontaktformular
            </a>
          </div>
