...
const VendorContest = () => {
  ...
  const handleVendorGuessChange = (index, value) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Produktionsmodus: Senden der Anfrage an unser Backend
      const response = await axios.post('/api/vendor-contest/submit', formData);
