  ...
  return (
    <div className="py-12 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8">Unsere Direktvermarkter</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-12 transform transition-all duration-300 hover:shadow-lg">
          ...
          <p className="text-gray-600 mb-4">
            Wir sind gerade dabei, ein vielfältiges Netzwerk regionaler Direktvermarkter aufzubauen. 
